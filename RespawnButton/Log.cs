...
namespace RespawnButton
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(RespawnButton) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{RespawnButtonPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
